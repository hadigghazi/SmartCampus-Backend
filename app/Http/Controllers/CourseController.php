...
class CourseController extends Controller
{
    ...
    {
        $course->load('major', 'faculty', 'exams', 'courseInstructors', 'prerequisites', 'prerequisiteCourses');
    ...
    public function suggestCoursesForNextSemester()
    {
        ...
        $prompt = "Given the following courses available for a student to register for the next semester and their performance in previously completed courses, suggest a set of courses with a maximum total of 12 credits(Do not EVER suggest anything over 12 credits, but less is okay). Make the response talking to the student himself and add some explanations on why he should choose the course.";
